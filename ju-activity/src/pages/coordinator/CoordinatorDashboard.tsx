      ...
      <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
        ...
        <Tabs defaultValue="overview" className="space-y-4">
                  ...
                  <div className="space-y-8">
                    {pendingApplications.slice(0, 5).map((application) => (
                      <div key={application.id} className="flex items-center">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => navigate("/coordinator/applications")}>
                          Review
                        </Button>
                      </div>
                    ))}
          ...
          <TabsContent value="activities" className="space-y-4">
             <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => navigate("/coordinator/activities")}>
          ...
          <TabsContent value="applications" className="space-y-4">
             <Card className="cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => navigate("/coordinator/applications")}>
                <CardHeader>
