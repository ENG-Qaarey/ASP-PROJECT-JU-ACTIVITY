        ...
        <Tabs defaultValue="overview" className="space-y-4">
          ...
          <TabsContent value="reports" className="space-y-4">
            {userStats.loading ? (
              ...
              <div className="grid gap-4 md:grid-cols-3">
              <Card className="cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => navigate(ROUTES.ADMIN.REPORTS)}>
                <CardHeader>
              ...
              <Card className="cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => navigate(ROUTES.ADMIN.APPLICATIONS)}>
                <CardHeader>
